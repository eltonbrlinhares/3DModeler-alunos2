 ...
 *
 * Todas as famílias são seções duplamente simétricas (I/H), por isso
 * `shape: "H"` para todas — usa o mesmo gerador de perfil I/H do backend
...
export const STEEL_FAMILY_OPTIONS = Object.keys(STEEL_COLUMN_FAMILIES).map((key) => ({
  value: key,
  label: STEEL_COLUMN_FAMILIES[key].label,
}));
